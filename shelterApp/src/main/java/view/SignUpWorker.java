...
public class SignUpWorker {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SignUpWorker window = new SignUpWorker();
	 ...
	 */
	public SignUpWorker(BenefiterService benefiterService, ShelterService shelterService, PetService petService,BasketService basketService) {
	...
	private void initialize() {
		...
		btnSignUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				benefiterService.saveBenefiter(email, name, (long)3);
